<?php
class ZendExtra_OpenId_Provider_Facebook extends ZendExtra_OpenId_Provider_Abstract {
    ...
    public function generateUsername($preferredUsername = NULL)
    {
        ...
        if(strpos($identity, 'http://www.facebook.com/profile.php?id=') !== false) {
            $id = str_replace('http://www.facebook.com/profile.php?id=', '', $identity);
